...
- Sidebar: logo sized proportionally within 44 px header, navigation 44 px high, 7 px corners, 8 px vertical gaps; botanical panel bottom aligned. Supplied mountain logo (`logo.png`) is used as primary brand mark across headers, favicon, and greeting section.
